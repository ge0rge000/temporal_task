...
public class LaptobWorker {
    ...
    public static void main(String[] args) {
        ...
        Worker worker = factory.newWorker(Shared.LAPOP_MODEL_IS_EXPENSIVE);
        // This Worker hosts both Workflow and Activity implementations.
        // Workflows are stateful, so you need to supply a type to create instances.
        worker.registerWorkflowImplementationTypes(LaptobWorkflowImpl.class);
